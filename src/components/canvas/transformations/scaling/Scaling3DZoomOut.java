...
public class Scaling3DZoomOut implements Transformation {
    ...
    public Scaling3DZoomOut(double x, double y, double z, double sx, double sy, double sz) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.sx = sx;
    ...
    public Scaling3DZoomOut(double sx, double sy, double sz) {
        this(0, 0, 0, sx, sy, sz);
    }

    public Scaling3DZoomOut(double x, double y, double z, double s) {
        this(x, y, z, s, s, s);
    }

    public Scaling3DZoomOut(double s) {
        this(0, 0, 0, s, s, s);
    }
    ...
    public TransformationData transform(TransformationData data) {
        ...
        Matrix4x4 S = TransformationMatrixFactory.scalingZoomOut(sx, sy, sz);
