...
public class Rotation3DZClockwise implements Transformation {
    private final double radians;
    private final double x;
    private final double y;
    private final double z;

    public Rotation3DZClockwise(double x, double y, double z, double degrees) {
    ...
    public Rotation3DZClockwise(double degrees) {
        this(0, 0, 0, degrees);
    }
    ...
    public TransformationData transform(TransformationData data) {
        ...
        Matrix4x4 R = TransformationMatrixFactory.rotation3DZClockwise(radians);
