...
public class Rotation3DYClockwise implements Transformation {
    private final double radians;
    private final double x;
    private final double y;
    private final double z;

    public Rotation3DYClockwise(double x, double y, double z, double degrees) {
    ...
    public Rotation3DYClockwise(double degrees) {
        this(0, 0, 0, degrees);
    }
    ...
    public TransformationData transform(TransformationData data) {
        ...
        Matrix4x4 R = TransformationMatrixFactory.rotation3DYClockwise(radians);
